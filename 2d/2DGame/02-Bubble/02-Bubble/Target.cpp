...
bool Target::loadObject(const string &file, ShaderProgram &shaderProgram) {
...
void Target::init(int id, const glm::ivec2 &tileMapPos, ShaderProgram &shaderProgram) {
	string file = "data/target";
...
void Target::update(int deltaTime) {
